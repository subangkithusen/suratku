...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('themes/app-assets/css/pages/page-auth.css')}}">
    <!-- END: Page CSS-->
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">App Surat</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{asset('themes/app-assets/images/pages/login-v2.svg')}}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">APP SURAT</h2>
                                <p class="card-text mb-2">Silahkan masukkan Email & Password dengan benar !</p>
                                <!-- form -->
